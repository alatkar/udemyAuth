...
export function fakeBackendFactory(
  ...
  //token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6Ik1vc2ggSGFtZWRhbmkiLCJhZG1pbiI6ZmFsc2V9.oEyti9UbZt78ejCXw9Ocv20zoqXp6ZWNMXDI_b6oICk';
  ...
  backend.connections.subscribe((connection: MockConnection) => {
    ...
    setTimeout(() => {
      ...
      if (connection.request.url.endsWith('/api/authenticate') &&
        ...
        if (body.email === 'alatkar@yahoo.com' && body.password === '1234') {
